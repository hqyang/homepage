...
1. **Large Language Models (LLMs)/GenAI Basics**: LLM Understanding (EMNLP'25; ECML PKDD'26; ACL'26), modular efficiency (EACL'26), agentic AI (ACL'26), etc.; and
2. **GenAI + X**: Data analytics (ACL'25; ACL'26), affective computing, and education, etc.

Previously, he worked in R&D at IDEA, Ping An Life, and other organisations. He has also held academic appointments at The Chinese University of Hong Kong (CUHK), serving as an Adjunct Associate Professor in the Department of Decision Sciences and Managerial Economics, and at Hang Seng Management College (now rebranded as Hang Seng University of Hong Kong) as an Assistant Professor in the Department of Computing, where he also served as Deputy Director of the Deep Learning Research and Application Centre.  He earned his Ph.D. from the Department of Computer Science and Engineering at CUHK, under the supervision of Professors [Irwin King](https://www.cse.cuhk.edu.hk/~king) and [Michael R. Lyu](https://www.cse.cuhk.edu.hk/~lyu). He also held an MPhil from the same department at CUHK and a Bachelor of Science degree from the Department of Computer Science and Technology at Nanjing University.
